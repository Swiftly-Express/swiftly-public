...
export const metadata: Metadata = {
  ...
  description: 'Learn how Swiftly Xpress works: Create account, enter package details, choose pickup/delivery, secure payment, real-time GPS tracking, and delivery confirmation. Simple, transparent, reliable.',
  keywords: ['how it works', 'delivery process', 'package tracking', 'GPS tracking', 'delivery steps', 'shipping guide'],
  openGraph: {
    title: 'How It Works - Swiftly Xpress',
