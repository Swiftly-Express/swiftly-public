...
export const metadata: Metadata = {
  ...
  description: 'Experience Smart Ride by Swiftly Xpress: on-demand delivery, ride-hailing, and logistics solutions. Fast, efficient, and technology-driven transportation services.',
  keywords: ['smart ride', 'on-demand delivery', 'ride hailing', 'logistics', 'transportation service', 'courier on demand'],
  openGraph: {
    title: 'Smart Ride - Swiftly Xpress',
